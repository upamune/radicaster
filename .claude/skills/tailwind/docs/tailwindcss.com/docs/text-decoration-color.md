...
## [Examples](https://tailwindcss.com/docs/text-decoration-color.html#examples)

### [Basic example](https://tailwindcss.com/docs/text-decoration-color.html#basic-example)

Use utilities like `decoration-sky-500` and `decoration-pink-500` to change the [text decoration](https://tailwindcss.com/docs/text-decoration-line.html) color of an element:

I’m Derek, an astro-engineer based in Tattooine. I like to build X-Wings at [My Company, Inc](https://tailwindcss.com/docs/text-decoration-color.html). Outside of work, I like to [watch pod-racing](https://tailwindcss.com/docs/text-decoration-color.html) and have [light-saber](https://tailwindcss.com/docs/text-decoration-color.html) fights.
...
### [Changing the opacity](https://tailwindcss.com/docs/text-decoration-color.html#changing-the-opacity)
...
### [Using a custom value](https://tailwindcss.com/docs/text-decoration-color.html#using-a-custom-value)
...
### [Applying on hover](https://tailwindcss.com/docs/text-decoration-color.html#applying-on-hover)
...
### [Responsive design](https://tailwindcss.com/docs/text-decoration-color.html#responsive-design)
...
## [Customizing your theme](https://tailwindcss.com/docs/text-decoration-color.html#customizing-your-theme)
...
* [Quick reference](https://tailwindcss.com/docs/text-decoration-color.html#quick-reference)
* [Examples](https://tailwindcss.com/docs/text-decoration-color.html#examples)
  + [Basic example](https://tailwindcss.com/docs/text-decoration-color.html#basic-example)
  + [Changing the opacity](https://tailwindcss.com/docs/text-decoration-color.html#changing-the-opacity)
  + [Using a custom value](https://tailwindcss.com/docs/text-decoration-color.html#using-a-custom-value)
