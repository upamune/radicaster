...
## [Examples](https://tailwindcss.com/docs/fill.html#examples)

### [Basic example](https://tailwindcss.com/docs/fill.html#basic-example)
...
### [Using the current color](https://tailwindcss.com/docs/fill.html#using-the-current-color)
...
### [Using a custom value](https://tailwindcss.com/docs/fill.html#using-a-custom-value)
...
### [Responsive design](https://tailwindcss.com/docs/fill.html#responsive-design)
...
## [Customizing your theme](https://tailwindcss.com/docs/fill.html#customizing-your-theme)
...
* [Quick reference](https://tailwindcss.com/docs/fill.html#quick-reference)
* [Examples](https://tailwindcss.com/docs/fill.html#examples)
  + [Basic example](https://tailwindcss.com/docs/fill.html#basic-example)
  + [Using the current color](https://tailwindcss.com/docs/fill.html#using-the-current-color)
  + [Using a custom value](https://tailwindcss.com/docs/fill.html#using-a-custom-value)
