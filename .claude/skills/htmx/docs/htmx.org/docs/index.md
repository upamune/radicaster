...
source_url: "https://htmx.org/docs/index"
fetched_at: "2025-12-31T10:27:53.702446+00:00"
---
...
## [htmx in a Nutshell](https://htmx.org/docs/index.html#introduction)
...
## [1.x to 2.x Migration Guide](https://htmx.org/docs/index.html#1-x-to-2-x-migration-guide)
...
## [Installing](https://htmx.org/docs/index.html#installing)
...
### [Via A CDN (e.g. jsDelivr)](https://htmx.org/docs/index.html#via-a-cdn-e-g-jsdelivr)
...
### [Download a copy](https://htmx.org/docs/index.html#download-a-copy)
...
### [npm](https://htmx.org/docs/index.html#npm)
...
### [Webpack](https://htmx.org/docs/index.html#webpack)
...
## [AJAX](https://htmx.org/docs/index.html#ajax)
...
type to the given URL when the element is [triggered](https://htmx.org/docs/index.html#triggers):
...
### [Triggering Requests](https://htmx.org/docs/index.html#triggers)
...
#### [Trigger Modifiers](https://htmx.org/docs/index.html#trigger-modifiers)
...
#### [Trigger Filters](https://htmx.org/docs/index.html#trigger-filters)
...
#### [Special Events](https://htmx.org/docs/index.html#special-events)
...
#### [Polling](https://htmx.org/docs/index.html#polling)
...
#### [Load Polling](https://htmx.org/docs/index.html#load_polling)
...
### [Request Indicators](https://htmx.org/docs/index.html#indicators)
...
### [Targets](https://htmx.org/docs/index.html#targets)
...
#### [Extended CSS Selectors](https://htmx.org/docs/index.html#extended-css-selectors)
...
### [Swapping](https://htmx.org/docs/index.html#swapping)
...
| `none` | does not append content from response ([Out of Band Swaps](https://htmx.org/docs/index.html#oob_swaps) and [Response Headers](https://htmx.org/docs/index.html#response-headers) will still be processed) |

#### [Morph Swaps](https://htmx.org/docs/index.html#morphing)
...
#### [View Transitions](https://htmx.org/docs/index.html#view-transitions)
...
#### [Swap Options](https://htmx.org/docs/index.html#swap-options)
...
### [Synchronization](https://htmx.org/docs/index.html#synchronization)
...
### [CSS Transitions](https://htmx.org/docs/index.html#css_transitions)
...
#### [Details](https://htmx.org/docs/index.html#details)
...
### [Out of Band Swaps](https://htmx.org/docs/index.html#oob_swaps)
...
#### [Troublesome Tables](https://htmx.org/docs/index.html#troublesome-tables)
...
#### [Selecting Content To Swap](https://htmx.org/docs/index.html#selecting-content-to-swap)
...
#### [Preserving Content During A Swap](https://htmx.org/docs/index.html#preserving-content-during-a-swap)
...
### [Parameters](https://htmx.org/docs/index.html#parameters)
...
#### [File Upload](https://htmx.org/docs/index.html#files)
...
#### [Extra Values](https://htmx.org/docs/index.html#extra-values)
...
### [Confirming Requests](https://htmx.org/docs/index.html#confirming)
...
#### [Confirming Requests Using Events](https://htmx.org/docs/index.html#confirming-requests-using-events)
...
## [Attribute Inheritance](https://htmx.org/docs/index.html#inheritance)
...
## [Boosting](https://htmx.org/docs/index.html#boosting)
...
### [Progressive Enhancement](https://htmx.org/docs/index.html#progressive_enhancement)
...
## [Web Sockets & SSE](https://htmx.org/docs/index.html#websockets-and-sse)
...
## [History Support](https://htmx.org/docs/index.html#history)
...
### [Specifying History Snapshot Element](https://htmx.org/docs/index.html#specifying-history-snapshot-element)
...
### [Undoing DOM Mutations By 3rd Party Libraries](https://htmx.org/docs/index.html#undoing-dom-mutations-by-3rd-party-libraries)
...
### [Disabling History Snapshots](https://htmx.org/docs/index.html#disabling-history-snapshots)
...
## [Requests & Responses](https://htmx.org/docs/index.html#requests)
...
Sometimes you might want to do nothing in the swap, but still perhaps trigger a client side event ([see below](https://htmx.org/docs/index.html#response-headers)).
...
### [Configuring Response Handling](https://htmx.org/docs/index.html#response-handling)
...
#### [Configuring Response Handling Examples](https://htmx.org/docs/index.html#response-handling-examples)
...
Using the [meta config](https://htmx.org/docs/index.html#configuration-options) mechanism for configuring responseHandling, we could add the following
config:
...
### [CORS](https://htmx.org/docs/index.html#cors)
...
### [Request Headers](https://htmx.org/docs/index.html#request-headers)
...
### [Response Headers](https://htmx.org/docs/index.html#response-headers)
...
### [Request Order of Operations](https://htmx.org/docs/index.html#request-operations)
...
## [Validation](https://htmx.org/docs/index.html#validation)
...
### [Validation Example](https://htmx.org/docs/index.html#validation-example)
...
## [Animations](https://htmx.org/docs/index.html#animations)

Htmx allows you to use [CSS transitions](https://htmx.org/docs/index.html#css_transitions)
...
## [Extensions](https://htmx.org/docs/index.html#extensions)
...
### [Core Extensions](https://htmx.org/docs/index.html#core-extensions)
...
### [Installing Extensions](https://htmx.org/docs/index.html#installing-extensions)

The fastest way to install htmx extensions created by others is to load them via a CDN. Remember to always include the core htmx library before the extensions and [enable the extension](https://htmx.org/docs/index.html#enabling-extensions). For example, if you would like to use the [response-targets](https://htmx.org/extensions/response-targets) extension, you can add this to your head tag:
...
### [Enabling Extensions](https://htmx.org/docs/index.html#enabling-extensions)
...
### [Creating Extensions](https://htmx.org/docs/index.html#creating-extensions)
...
## [Events & Logging](https://htmx.org/docs/index.html#events)
...
### [Initialize A 3rd Party Library With Events](https://htmx.org/docs/index.html#init_3rd_party_with_events)
...
### [Configure a Request With Events](https://htmx.org/docs/index.html#config_request_with_events)
...
### [Modifying Swapping Behavior With Events](https://htmx.org/docs/index.html#modifying_swapping_behavior_with_events)
...
### [Event Naming](https://htmx.org/docs/index.html#event_naming)
...
### [Logging](https://htmx.org/docs/index.html#logging)
...
## [Debugging](https://htmx.org/docs/index.html#debugging)
...
### [Creating Demos](https://htmx.org/docs/index.html#creating-demos)
...
#### [Demo Example](https://htmx.org/docs/index.html#demo-example)
...
## [Scripting](https://htmx.org/docs/index.html#scripting)
...
The primary integration point between htmx and scripting solutions is the [events](https://htmx.org/docs/index.html#events) that htmx sends and can
respond to. See the SortableJS example in the [3rd Party Javascript](https://htmx.org/docs/index.html#3rd-party) section for a good template for
...
### [[The `hx-on*` Attributes](https://htmx.org/docs/index.html#hx-on)](index.html#the-hx-on-attributes)
...
### [3rd Party Javascript](https://htmx.org/docs/index.html#3rd-party)
...
## [Security](https://htmx.org/docs/index.html#security)
...
### [Rule 1: Escape All User Content](https://htmx.org/docs/index.html#rule-1-escape-all-user-content)
...
### [htmx Security Tools](https://htmx.org/docs/index.html#htmx-security-tools)
...
#### [`hx-disable`](https://htmx.org/docs/index.html#hx-disable)
...
#### [`hx-history`](https://htmx.org/docs/index.html#hx-history)
...
#### [Configuration Options](https://htmx.org/docs/index.html#configuration-options)
...
#### [Events](https://htmx.org/docs/index.html#events-1)
...
### [CSP Options](https://htmx.org/docs/index.html#csp-options)
...
### [CSRF Prevention](https://htmx.org/docs/index.html#csrf-prevention)
...
## [Configuring htmx](https://htmx.org/docs/index.html#config)
...
| `htmx.config.responseHandling` | the default [Response Handling](https://htmx.org/docs/index.html#response-handling) behavior for response status codes can be configured here to either swap or error |
...
## [Conclusion](https://htmx.org/docs/index.html#conclusion)
