---
title: "react/jsx-curly-brace-presence | The JavaScript Oxidation Compiler"
source_url: "https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.md for this page in Markdown format

# react/jsx-curly-brace-presence Style [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#react-jsx-curly-brace-presence)
...
## Rule Details [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#rule-details)
...
**Note**: it is *highly recommended* that you configure this rule with an object, and that you set "propElementValues" to "always". The ability to omit curly braces around prop values that are JSX elements is obscure, and intentionally undocumented, and should not be relied upon.

## Rule Options [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#rule-options)
...
### Valid options for `<string>` [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#valid-options-for-string)
...
### Alternative syntax [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#alternative-syntax)
...
## Edge cases [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#edge-cases)
...
## When Not To Use It [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#when-not-to-use-it)
...
## Configuration [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#configuration)

This rule accepts a configuration object with the following properties:

### children [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#children)

type: `"always" | "never" | "ignore"`

default: `"never"`

### propElementValues [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#propelementvalues)

type: `"always" | "never" | "ignore"`

default: `"ignore"`

### props [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#props)

type: `"always" | "never" | "ignore"`

default: `"never"`

## How to use [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#how-to-use)
...
## References [​](https://oxc.rs/docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.html#references)

* [Rule Source](https://github.com/oxc-project/oxc/blob/1bf0ffc0f6859c90409a9701e62e8957ef1286cc/crates/oxc_linter/src/rules/react/jsx_curly_brace_presence.rs)
