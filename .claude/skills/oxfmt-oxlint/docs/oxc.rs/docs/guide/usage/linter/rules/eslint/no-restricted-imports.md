---
title: "eslint/no-restricted-imports | The JavaScript Oxidation Compiler"
source_url: "https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/linter/rules/eslint/no-restricted-imports.md for this page in Markdown format

# eslint/no-restricted-imports Restriction [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#eslint-no-restricted-imports)

### What it does [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#what-it-does)
...
### Why is this bad? [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#why-is-this-bad)
...
### Examples [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#examples)
...
### Options [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#options)

You may also specify a custom message for a particular module using the `name` and `message` properties inside an object, where the value of the name is the `name` of the module and message property contains the custom message. The custom message will be displayed as a help text for the user.
...
#### paths [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#paths)
...
##### importNames [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#importnames)
...
##### allowImportNames [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#allowimportnames)
...
#### allowTypeImports [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#allowtypeimports)
...
#### patterns [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#patterns)
...
##### group [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#group)
...
##### regex [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#regex)
...
**Warning**: This rule uses the [Rust-Regex](https://docs.rs/regex/latest/regex/), which supports not all features of JS-Regex, like Lookahead and Lookbehinds.
...
##### caseSensitive [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#casesensitive)
...
##### importNames [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#importnames-1)
...
##### allowImportNames [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#allowimportnames-1)
...
##### importNamePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#importnamepattern)
...
##### allowImportNamePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#allowimportnamepattern)
...
## How to use [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#how-to-use)
...
## References [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-restricted-imports.html#references)

* [Rule Source](https://github.com/oxc-project/oxc/blob/1bf0ffc0f6859c90409a9701e62e8957ef1286cc/crates/oxc_linter/src/rules/eslint/no_restricted_imports.rs)
