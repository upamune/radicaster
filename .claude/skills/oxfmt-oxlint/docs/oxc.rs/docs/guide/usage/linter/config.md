...
source_url: "https://oxc.rs/docs/guide/usage/linter/config"
...
All available rules are listed in the [Rules reference](https://oxc.rs/docs/guide/usage/linter/rules.html).
...
## Configure JS plugins (experimental) [​](https://oxc.rs/docs/guide/usage/linter/config.html#configure-js-plugins-experimental)
