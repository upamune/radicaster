---
title: "JS Plugins | The JavaScript Oxidation Compiler"
source_url: "https://oxc.rs/docs/guide/usage/linter/js-plugins"
...
# JS Plugins [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#js-plugins)
...
JS plugins are currently in technical preview, and remain under heavy development. Almost all of ESLint's plugin API is implemented (see [here](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#api-support)).

All APIs should behave identically to ESLint. If you find any differences in behavior, that's a bug - please [report it](https://github.com/oxc-project/oxc/issues/new?template=linter_bug_report.yaml).
...
Path can be any valid import specifier e.g. `./plugin.js` or `plugin-package`. Paths are resolved relative to the config file itself.
...
### Plugin aliases [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#plugin-aliases)
...
## Writing JS plugins [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#writing-js-plugins)

### ESLint-compatible API [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#eslint-compatible-api)

Oxlint provides a plugin API identical to ESLint's. See ESLint's docs on [creating a plugin](https://eslint.org/docs/latest/extend/plugins) and [custom rules](https://eslint.org/docs/latest/extend/custom-rules).
...
### Alternative API [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#alternative-api)

Oxlint also provides a slightly different alternative API which is more performant.

Rules created with this API **remain compatible with ESLint** (see [below](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#what-does-definerule-do)).
...
3. `create` (ESLint's API) is called repeatedly *for each file*, whereas `createOnce` is called once only. Perform any per-file setup in `before` hook instead.
...
#### What does `defineRule` do? [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#what-does-definerule-do)
...
#### `definePlugin` [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#defineplugin)
...
#### Skipping AST traversal [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#skipping-ast-traversal)
...
#### `before` hook [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#before-hook)
...
#### `after` hook [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#after-hook)
...
Same as `before` hook, `after` hook is NOT guaranteed to run on every file (see [above](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#when-before-hook-runs)).

### Why is the alternative API faster? [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#why-is-the-alternative-api-faster)
...
#### What are those optimizations? [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#what-are-those-optimizations)
...
## API support [​](https://oxc.rs/docs/guide/usage/linter/js-plugins.html#api-support)
