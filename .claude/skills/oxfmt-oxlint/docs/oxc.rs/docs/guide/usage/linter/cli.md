...
source_url: "https://oxc.rs/docs/guide/usage/linter/cli"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/linter/cli.md for this page in Markdown format

# Command-line Interface [​](https://oxc.rs/docs/guide/usage/linter/cli.html#command-line-interface)

## Usage [​](https://oxc.rs/docs/guide/usage/linter/cli.html#usage)

**`oxlint`** [**`-c`**=*`<./.oxlintrc.json>`*] [*`PATH`*]...

## Basic Configuration [​](https://oxc.rs/docs/guide/usage/linter/cli.html#basic-configuration)
...
## Allowing / Denying Multiple Lints [​](https://oxc.rs/docs/guide/usage/linter/cli.html#allowing-denying-multiple-lints)
...
## Enable/Disable Plugins [​](https://oxc.rs/docs/guide/usage/linter/cli.html#enable-disable-plugins)
...
## Fix Problems [​](https://oxc.rs/docs/guide/usage/linter/cli.html#fix-problems)
...
## Ignore Files [​](https://oxc.rs/docs/guide/usage/linter/cli.html#ignore-files)
...
## Handle Warnings [​](https://oxc.rs/docs/guide/usage/linter/cli.html#handle-warnings)
...
## Output [​](https://oxc.rs/docs/guide/usage/linter/cli.html#output)

* **`-f`**, **`--format`**=*`ARG`* — Use a specific output format. Possible values: `checkstyle`, `default`, `github`, `gitlab`, `json`, `junit`, `stylish`, `unix`

## Miscellaneous [​](https://oxc.rs/docs/guide/usage/linter/cli.html#miscellaneous)
...
## Inline Configuration Comments [​](https://oxc.rs/docs/guide/usage/linter/cli.html#inline-configuration-comments)
...
## Available positional items: [​](https://oxc.rs/docs/guide/usage/linter/cli.html#available-positional-items)

* *`PATH`* — Single file, single path or list of paths

## Available options: [​](https://oxc.rs/docs/guide/usage/linter/cli.html#available-options)
