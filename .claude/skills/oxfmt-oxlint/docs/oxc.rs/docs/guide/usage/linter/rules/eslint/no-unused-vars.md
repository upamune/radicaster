---
title: "eslint/no-unused-vars | The JavaScript Oxidation Compiler"
source_url: "https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/linter/rules/eslint/no-unused-vars.md for this page in Markdown format

# eslint/no-unused-vars Correctness [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#eslint-no-unused-vars)

✅ This rule is turned on by default.

⚠️💡 A dangerous suggestion is available for this rule.

### What it does [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#what-it-does)

Disallows variable declarations, imports, or type declarations that are not used in code.

### Why is this bad? [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#why-is-this-bad)
...
#### Types [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#types)

This rule has full support for TypeScript types, interfaces, enums, and namespaces.

A type or interface `Foo` is considered to be used if it is used in any of the following ways:
...
A type or interface is *not* considered to be used if it is only ever used in its own definition, e.g. `type Foo = Array<Foo>`.

Enums and namespaces are treated the same as variables, classes, functions, etc.

#### Ignored Files [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#ignored-files)

This rule ignores `.d.ts` files and `.vue` files entirely. Variables, classes, interfaces, and types declared in `.d.ts` files are generally used by other files, which are not checked by Oxlint. Since Oxlint does not support parsing Vue templates, this rule cannot tell if a variable is used or unused in a Vue file.

#### Exported [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#exported)

The original ESLint rule recognizes `/* exported variableName */` comments as a way to indicate that a variable is used in another script and should not be considered unused. Since ES modules are now a TC39 standard, Oxlint does not support this feature.

### Examples [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#examples)
...
## Configuration [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#configuration)

This rule accepts a configuration object with the following properties:

### args [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#args)
...
#### `"after-used"` [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#after-used)
...
#### `"all"` [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#all)

All named arguments must be used

#### `"none"` [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#none)

Do not check arguments

### argsIgnorePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#argsignorepattern)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example)
...
### caughtErrors [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#caughterrors)
...
### caughtErrorsIgnorePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#caughterrorsignorepattern)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-1)
...
### destructuredArrayIgnorePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#destructuredarrayignorepattern)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-2)
...
### ignoreClassWithStaticInitBlock [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#ignoreclasswithstaticinitblock)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-3)
...
### ignoreRestSiblings [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#ignorerestsiblings)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-4)
...
### ignoreUsingDeclarations [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#ignoreusingdeclarations)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-5)
...
### reportUsedIgnorePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#reportusedignorepattern)
...
#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-6)
...
### reportVarsOnlyUsedAsTypes [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#reportvarsonlyusedastypes)
...
#### Examples [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#examples-1)
...
### vars [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#vars)
...
#### `"all"` [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#all-1)

All variables are checked for usage, including those in the global scope.

#### `"local"` [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#local)

Checks only that locally-declared variables are used but will allow global variables to be unused.

### varsIgnorePattern [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#varsignorepattern)

Specifies exceptions to this rule for unused variables. Variables whose names match this pattern will be ignored.

By default, this pattern is `^_` unless options are configured with an object. In this case it will default to [`None`]. Note that this behavior deviates from both ESLint and TypeScript-ESLint, which never provide a default pattern.

#### Example [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#example-7)
...
## How to use [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#how-to-use)
...
## References [​](https://oxc.rs/docs/guide/usage/linter/rules/eslint/no-unused-vars.html#references)

* [Rule Source](https://github.com/oxc-project/oxc/blob/1bf0ffc0f6859c90409a9701e62e8957ef1286cc/crates/oxc_linter/src/rules/eslint/no_unused_vars/mod.rs)
