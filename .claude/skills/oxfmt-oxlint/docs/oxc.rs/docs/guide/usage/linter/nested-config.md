---
title: "Nested configuration files | The JavaScript Oxidation Compiler"
source_url: "https://oxc.rs/docs/guide/usage/linter/nested-config"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/linter/nested-config.md for this page in Markdown format

# Nested configuration files [​](https://oxc.rs/docs/guide/usage/linter/nested-config.html#nested-configuration-files)
...
If you only need to exclude files or folders, use [Ignores](https://oxc.rs/docs/guide/usage/linter/ignore-files.html) instead.

## How it works [​](https://oxc.rs/docs/guide/usage/linter/nested-config.html#how-it-works)
...
## What to expect [​](https://oxc.rs/docs/guide/usage/linter/nested-config.html#what-to-expect)
...
## Monorepo pattern: share a base config with extends [​](https://oxc.rs/docs/guide/usage/linter/nested-config.html#monorepo-pattern-share-a-base-config-with-extends)
...
## Extending configuration files [​](https://oxc.rs/docs/guide/usage/linter/nested-config.html#extending-configuration-files)
