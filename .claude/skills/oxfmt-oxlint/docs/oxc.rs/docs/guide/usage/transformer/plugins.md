...
source_url: "https://oxc.rs/docs/guide/usage/transformer/plugins"
fetched_at: "2025-12-31T10:44:14.234719+00:00"
---



Are you an LLM? You can read better optimized documentation at /docs/guide/usage/transformer/plugins.md for this page in Markdown format

# Built-in Plugins [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#built-in-plugins)
...
## Styled Components [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#styled-components)
...
### Basic Usage [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#basic-usage)
...
### Example [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#example)
...
### Configuration Options [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#configuration-options)

#### Core Options [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#core-options)
...
#### Template Literal Options [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#template-literal-options)
...
#### Advanced Options [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#advanced-options)
...
#### Not Yet Implemented [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#not-yet-implemented)
...
### Supported Import Patterns [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#supported-import-patterns)
...
### Features [​](https://oxc.rs/docs/guide/usage/transformer/plugins.html#features)
